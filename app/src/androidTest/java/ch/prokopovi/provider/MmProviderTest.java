...
public class MmProviderTest extends AndroidTestCase {

	private static final String LOG_TAG = "MmProviderTest";
	...
	public void testUpdate() throws WebUpdatingException {
		...
		ProviderRequirements requirements = new ProviderRequirements(ProviderCode.MM, inRateType);
		...
		assertTrue("result has wrong size", list.size() == 6);
