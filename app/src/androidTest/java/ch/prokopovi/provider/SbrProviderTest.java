...
public class SbrProviderTest extends AndroidTestCase {

	private static final String LOG_TAG = "SbrProviderTest";
	...
	public void testUpdate() throws WebUpdatingException {
		...
		ProviderRequirements requirements = new ProviderRequirements(ProviderCode.SBR, inRateType);
