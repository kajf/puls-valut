...
public class NbuProviderTest extends AndroidTestCase {
	private static final String LOG_TAG = "NbuProviderTest";
	...
	public void testUpdate() throws WebUpdatingException {
		...
		ProviderRequirements requirements = new ProviderRequirements(ProviderCode.NBU, inRateType);
