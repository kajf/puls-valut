...
public class AlfaProviderTest extends AndroidTestCase {

	private static final String LOG_TAG = "AlfaProviderTest";
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.provider = new AlfaProvider();
	}
	...
	public void testUpdate() throws WebUpdatingException {
		...
		ProviderRequirements requirements = new ProviderRequirements(ProviderCode.ALFA, inRateType);
