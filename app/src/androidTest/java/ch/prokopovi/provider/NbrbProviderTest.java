...
public class NbrbProviderTest extends AndroidTestCase {

	private static final String LOG_TAG = "NbrbProviderTest";
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.provider = new NbrbProvider();
	}
	...
	public void testUpdate() throws WebUpdatingException {
		...
		ProviderRequirements requirements = new ProviderRequirements(ProviderCode.NBRB, inRateType);
